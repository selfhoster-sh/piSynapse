...
# Per-user credential encryption key (Fernet). Generated by the installer;
# auto-created on first use if missing (old installs).
MAIL_CREDS_KEY = os.getenv("MAIL_CREDS_KEY", "")
