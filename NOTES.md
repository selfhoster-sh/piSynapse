...
- **Open (MADDE 2):** live repro of the single-group narrowing depends on the model emitting the marker; rare/non-deterministic — covered by unit test (`test_escalation_tools_single_group`). Full accounting in `BUG_RAFLAMA_DURUM.md` §8.
